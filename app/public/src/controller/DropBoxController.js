class DropBoxController {
    ...
    getFirebaseRef(path) {
        ...
        //defines de path of the files and returns the refference  
    ...
    removeFolderTask(ref, name) {
        ...
        //Remove the  folder and all the files inside
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                ...
                responses.forEach(resp => {
                    ...
                    let fullPath = resp.fullPath.replaceAll('/', '%2F');

                    let path = 'https://firebasestorage.googleapis.com/v0/b/' + resp.bucket + '/o/' + fullPath + '?alt=media';
    ...
    uploadProgress(event, file) {
        ...
        // Tell how much time has left for the upload finish to formatTimetoHuman() and update the progress bar
    ...
    formatTimeToHuman(duration) {
        ...
        //Get the time left and returns it in hours minutes and seconds (depending of the time left) for the user
    ...
    getFileIconView(file) {
        ...
        //A swtich that returns a diferent HTML depending on the file type
    ...
    getFileView(file, key) {
        ...
        // receithe HTML from getFileIconView and structure it with the file informations
    ...
    readFiles() {
        ...
        //get all data received from  get FirebaseRef and create the html child element
    ...
    renderNav() {
        ...
        //Update de navegation bar while the user navegate within the file
