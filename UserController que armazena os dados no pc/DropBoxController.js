class DropBoxController {
    ...
    connectFirebase() {
        ...
        const firebaseConfig = {
            ...
            authDomain: "projeto-00000.firebaseapp.com",
            databaseURL: "https://teste.com",
            projectId: "projeto-00000",
    ...
    initEvents() {
        ...
        this.btnNewFolder.addEventListener('click', e => {
            ...
            let originalFilename = prompt("Nome da pasta:");
        ...
        this.listFilesEl.addEventListener('selectionchange', e => {
            ...
            let n = this.getSelection().length;
    ...
    ajax(url, method = 'GET', formData = new FormData, onprogress = function () { }, onloadstart = function () { }) {
        ...
        //Um dos metodos principais do app, define o metodo  o caminho utilizado e o
    ...
    uploadProgress(event, file) {
        ...
        // fala quanto tempo falta para o download acabar de acordo com a porcentagem e a hora
    ...
    formatTimeToHuman(duration) {
        ...
        // transforma os milisegundos recebidos do tempo de download em hora capaz de ser reconhecida pelos olhos humanos
    ...
    getFileIconView(file) {
        ...
        //Dependendo do arquivo recebido passa o o html diferente criando a capacidade de diferenciar entre os arquivos
    ...
    getFileView(file, key) {
        ...
        // recebo o tipo de arquivo a ser criado no HTML e estrutura ele criando um elemento HTML pois appendChild passa elemento nãa texto e retorna ele
    ...
    readFiles() {
        ...
        //pega os dados que veio do metodo que pegou os dados do firebase "getFirebaseRef()", e cria o elemento filho no html 
